...
<div class="form-group">
	...
	if(!empty($proverb_lang)){
		 $nativelang = set_value('reference_lang', $user_nativelang);
	}
	?>
    <?php  echo form_dropdown('reference_lang', $user_lang, $nativelang, 'id="reference_lang" class="form-control"');  ?>
...
<div class="form-group">
    ...
    <?php echo form_input(['name'=>'reference_title', 'id'=>'reference_title', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter Proverb', 'value'=>set_value('reference_title')]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_input(['name'=>'reference_author', 'id'=>'reference_author', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter in Latin English', 'value'=>set_value('reference_author')]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'reference_introduction', 'id'=>'reference_introduction', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter Introduction to simply understand what it is all about', 'value'=>set_value('reference_introduction')]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_input(['name'=>'reference_published_year', 'id'=>'reference_published_year', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter Reference Published Year', 'value'=>set_value('reference_published_year')]); ?>
