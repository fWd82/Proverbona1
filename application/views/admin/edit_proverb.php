...
<?= form_open(base_url("proverb/update_proverb/{$edit_proverb->proverb_id}")); ?>
...
<div class="form-group">
	...
	if(!empty($proverb_lang)){
		 $nativelang = set_value('proverb_lang', $edit_proverb->proverb_lang);
	}
	?>
    <?php  echo form_dropdown('proverb_lang', $user_lang, $edit_proverb->proverb_lang, 'id="proverb_lang" class="form-control"');  ?>
...
<div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'proverb_statement', 'id'=>'proverb_statement', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter Proverb', 'value'=>set_value('proverb_statement', $edit_proverb->proverb_statement)]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'proverb_latin_eng', 'id'=>'proverb_latin_eng', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter in Latin English', 'value'=>set_value('proverb_latin_eng', $edit_proverb->proverb_latin_eng)]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'proverb_introduction', 'id'=>'proverb_introduction', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter Proverb introduction to simply understand what it is all about', 'value'=>set_value('proverb_introduction', $edit_proverb->proverb_introduction)]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'proverb_eng_meaning', 'id'=>'proverb_eng_meaning', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter English Meaning', 'value'=>set_value('proverb_eng_meaning', $edit_proverb->proverb_eng_meaning)]); ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'proverb_history', 'id'=>'proverb_history', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter History', 'value'=>set_value('proverb_history', $edit_proverb->proverb_history)]); ?>
  ...
  <div class="form-group">
	...
	?>
    <?php  echo form_dropdown('proverb_reference', $dd_reference, $edit_proverb->proverb_reference, 'id="proverb_reference" class="form-control"');  ?>
  ...
  <div class="form-group">
    ...
    <?php echo form_textarea(['name'=>'proverb_tags', 'id'=>'proverb_tags', 'rows'=>'3', 'class'=>'form-control', 'placeholder'=>'Enter Tags', 'value'=>set_value('proverb_tags', $edit_proverb->proverb_tags)]); ?>
