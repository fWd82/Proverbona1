...
<div class="container"> 
  ...
  <div class="form-group">
    <label for="feedback_type">Feedback Type<span title="Mandatory" class="colorred">*</span></label>
    <?php 
    $options = array(
  ...
  <div class="form-group">
    <label for="feedback_title">Feedback Title<span title="Mandatory" class="colorred">*</span></label>
    ...
    <div class="form-group">
      <label for="feedback_body">Feedback Body<span title="Mandatory" class="colorred">*</span></label>
